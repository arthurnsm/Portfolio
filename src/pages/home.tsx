...
function Home() {
    return (
        <>
            <section className='flex flex-col md:flex-row md:mt-12  items-center  md:justify-around'>
                <div className=" flex flex-col items-center gap-6">
                    <motion.span
                        initial={{ x: -50, opacity: 0 }}
                        animate={{ x: 0, opacity: 1 }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="text-[40px] sm:text-4xl md:text-[150px] lg:text-[150px] text-[#9D00FF]  font-[agdasima] font-bold drop-shadow-[0_0_8px_#9D00FF] animate-fade-in ">
                        ARTHUR ROBERTO
                    </motion.span>
                    <motion.span
                        initial={{ x: -50, opacity: 0 }}
                        ...
                        className="md:text-6xl text-lg mt-[-39px] text-start md:mt-[-40px] text-[#7C3AED] drop-shadow-[0_0_10px_#7C3AED] font-light font-[inter] ">Desenvolvedor Front-End</motion.span>
                    ...
                    <div className='gap-10'>
                        <motion.p
                            ...
                            animate={{ x: 0, opacity: 1 }}
                            transition={{ duration: 0.9, ease: "easeOut" }}
                            className="flex md:text-2xl md:w-220 w-80 text-sm text-center text-white">Desenvolvo soluções web responsivas que unem a estética do design moderno
                    ...
                    <motion.div
                        ...
                        <a href="#download" className="p-2 md:w-60 h-18 rounded-[22px] bg-[#9D00FF] transition-all duration-300 hover:scale-110 hover:text-white hover:bg-[#9D00FF] text-white flex justify-center items-center md:text-3xl text-2xl font-medium hover:drop-shadow-[0_0_10px_#9D00FF] ">Currículo <Download className="ml-2" size={30} />
                        </a>
                ...
                <div className='align-center flex-col  gap-8 mt-6 justify-center w-full max-w-sm h-auto items-center flex'>
                    ...
                    <motion.div
                        ...
                        className='md:mt-8   flex md:justify-center justify-evenly md:items-center gap-8 md:gap-14'>
